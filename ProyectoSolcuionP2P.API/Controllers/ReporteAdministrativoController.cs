...
namespace ProyectoSolucionP2P.API.Controllers
{
    ...
    public class ReporteAdministrativoController : ControllerBase
    {
        ...
        public ReporteAdministrativoController(IReporteAdministrativoService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(ReporteAdministrativo model)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, ReporteAdministrativo model)
        {
